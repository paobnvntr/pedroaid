		...
		<div class="container" data-aos="fade-up">
            ...
            <div class="d-flex justify-content-center row">
                <div class="card shadow p-5 col-sm-6 mb-sm-0 trackerDetailsForm">
                    ...
                    <form action="{{ route('appointmentReschedule', $appointment->appointment_id) }}" method="POST" class="user" enctype="multipart/form-data" id="rescheduleForm">
                        @csrf
                        ...
                        <div class="d-flex align-items-center justify-content-between row">
                            ...
                            <a href="{{ route('refreshAppointment', $appointment->appointment_id) }}" class="btn btn-danger col-sm-3">Cancel</a>
                        </div>
                    </form>
                </div>
                <div class="card shadow col-sm-3 trackerAppointmentDetails">
                    <div class="d-flex flex-column justify-content-center">
                        <a href="{{ route('refreshReschedule', $appointment->appointment_id) }}" class="btn btn-primary"><i class="ri-refresh-line icon"></i> Refresh Page</a>
                        <hr>
...
<script>
    ...
    rescheduleBtn.addEventListener("click", async () => {
        ...
        try {
            const response = await fetch('{{ route('validateReschedule', $appointment->appointment_id) }}', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '{{ csrf_token() }}', // Add CSRF token
                },
