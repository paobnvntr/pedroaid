            ...
            <div class="d-flex justify-content-center row">
                <div class="card shadow p-5 col-sm-6 mb-sm-0 trackerDetailsForm">
                    ...
                    <div>
                        ...
                        <form action="{{ route('editFeedback', ['id' => $appointment->appointment_id, 'type' => 'Appointment']) }}" method="POST" class="user feedback-form" id="sendFeedbackForm">
                            @csrf
                            <div class="mb-3">
                ...
                <div class="card shadow col-sm-3 trackerAppointmentDetails">
                    <div class="d-flex flex-column justify-content-center">
                        <a href="{{ route('refreshEditFeedback', $appointment->appointment_id) }}" class="btn btn-primary"><i class="ri-refresh-line icon"></i> Refresh Page</a>
                        <hr>
