		...
		<div class="container" data-aos="fade-up">
			...
			<header class="section-header">
                <div class="text-center text-lg-start d-flex align-items-center justify-content-between">
                    ...
                    <a href="{{ route('refreshAppointment', $appointment->appointment_id) }}"
            ...
            <div class="d-flex justify-content-center row">
                <div class="card shadow p-5 col-sm-6 mb-sm-0 trackerDetailsForm">
                    ...
                    <div>
                        ...
                        @endif
                        <form action="{{ route('sendFeedback', ['id' => $appointment->appointment_id, 'type' => 'Appointment']) }}" method="POST" class="user feedback-form" id="sendFeedbackForm">
                            @csrf
                            <div class="mb-3">
                                ...
                                <div class="form-check ml-4">
                                    <input class="form-check-input" type="radio" name="rating" value="Very Good" id="rating-verygood">
                            ...
                            <textarea class="form-control form-control-textbox" id="comment" name="comment" rows="3" placeholder="Type Comment">{{ old('comment') }}</textarea>
                ...
                <div class="card shadow col-sm-3 trackerAppointmentDetails">
                    <div class="d-flex flex-column justify-content-center">
                        <a href="{{ route('refreshFeedback', $appointment->appointment_id) }}" class="btn btn-primary"><i class="ri-refresh-line icon"></i> Refresh Page</a>
                        <hr>
...
<script>
    ...
    sendFeedbackBtn.addEventListener("click", async () => {
        ...
        try {
            const response = await fetch('{{ route('validateFeedbackForm', ['id' => $appointment->appointment_id, 'type' => 'Appointment']) }}', {
                method: 'POST',
                headers: {
