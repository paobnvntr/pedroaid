...
<div class="form-group">
    <input name="guardian_occupation" id="guardian_occupation" type="text" class="form-control @error('guardian_occupation')is-invalid @enderror" placeholder="Guardian's Occupation">
...
<div class="form-group">
    ...
    <input name="barangay_clearance" id="barangay_clearance" type="file" accept=".pdf" class="form-control @error('barangay_clearance')is-invalid @enderror">
...
<div class="form-group">
    ...
    <input name="relationship" id="relationship" type="text" class="form-control @error('relationship')is-invalid @enderror" placeholder="Relationship">
    @error('relationship')
    <span class="invalid-feedback">{{ $message }}</span>
    @enderror
</div>
...
<div class="form-group">
    ...
    <input name="minor_relationship" id="minor_relationship" type="text" class="form-control @error('minor_relationship')is-invalid @enderror" placeholder="Relationship">
