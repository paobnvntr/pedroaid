...
<div class="form-group row">
    <div class="col-sm-6">
        <input name="name_of_vendor" id="name_of_vendor" type="text"
            ...
            placeholder="Name and Identity of Vendor" value="{{ old('name_of_vendor') }}">
...
<div class="form-group row">
    <div class="col-sm-6">
        <label for="property_document">Property Document (or Vehicle OR/CR):</label>
        <input name="property_document" id="property_document" type="file" accept=".pdf" class="form-control @error('property_document')is-invalid @enderror">
    ...
    <div class="col-sm-6">
        ...
        <input name="property_price" id="property_price" class="form-control @error('property_price') is-invalid @enderror" type="text" placeholder="Price of the Property/Vehicle in Deed of Sale" value="{{ old('property_price') }}">
...
<div class="form-group row">
    <div class="form-group row">
        <div class="col-sm-6">
            <label for="vendor_valid_id_front">Vendor Valid ID (Front):</label>
            <input name="vendor_valid_id_front" id="vendor_valid_id_front" type="file" accept="image/jpeg, image/jpg, image/png" class="form-control @error('vendor_valid_id_front')is-invalid @enderror">
        ...
        <div class="col-sm-6">
            <label for="vendor_valid_id_back">Vendor Valid ID (Back):</label>
            <input name="vendor_valid_id_back" id="vendor_valid_id_back" type="file" accept="image/jpeg, image/jpg, image/png" class="form-control @error('vendor_valid_id_back')is-invalid @enderror">
...
<div class="form-group">
    <input name="name_of_vendee" id="name_of_vendee" type="text"
        ...
        placeholder="Name and Identity of Vendee" value="{{ old('name_of_vendee') }}">
...
<div class="form-group row">
    <div class="form-group row">
        <div class="col-sm-6">
            <label for="vendee_valid_id_front">Vendee Valid ID (Front):</label>
            <input name="vendee_valid_id_front" id="vendee_valid_id_front" type="file" accept="image/jpeg, image/jpg, image/png" class="form-control @error('vendee_valid_id_front')is-invalid @enderror">
        ...
        <div class="col-sm-6">
            <label for="vendee_valid_id_back">Vendee Valid ID (Back):</label>
            <input name="vendee_valid_id_back" id="vendee_valid_id_back" type="file" accept="image/jpeg, image/jpg, image/png" class="form-control @error('vendee_valid_id_back')is-invalid @enderror">
...
<div class="form-group">
    <input name="name_of_witness" id="name_of_witness" type="text"
        ...
        placeholder="Name and Identity of Witness" value="{{ old('name_of_witness') }}">
...
<div class="form-group row">
    <div class="form-group row">
        <div class="col-sm-6">
            <label for="witness_valid_id_front">Witness Valid ID (Front):</label>
            <input name="witness_valid_id_front" id="witness_valid_id_front" type="file" accept="image/jpeg, image/jpg, image/png" class="form-control @error('witness_valid_id_front')is-invalid @enderror">
        ...
        <div class="col-sm-6">
            <label for="witness_valid_id_back">Witness Valid ID (Back):</label>
            <input name="witness_valid_id_back" id="witness_valid_id_back" type="file" accept="image/jpeg, image/jpg, image/png" class="form-control @error('witness_valid_id_back')is-invalid @enderror">
