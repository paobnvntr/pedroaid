<div class="p-5 card shadow clientDetailsForm" id="clientDetailsForm">
    ...
    <form action="{{ route('saveAppointment') }}" method="POST" id="appointmentForm" class="user" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <label for="address">Client Address: <span class="text-danger">*</span></label>
            ...
            <div class="form-group row {{ old('city') == 'san-pedro-city' ? '' : 'd-none' }}" id="barangay-group">
                <div class="col-sm-12 position-relative">
            ...
            <div class="form-group row {{ old('city') == 'san-pedro-city' ? '' : 'd-none' }}" id="street-group">
                <div class="col-sm-12 position-relative">
