						...
						<div class="col-lg-6 col-md-6" data-aos="fade-up" data-aos-delay="200">
							<div class="ordinance-box green">
								...
								<div class="d-flex align-items-center justify-content-end">
									<span id="view_count_{{ $ord->id }}" class="dateApproved">Views: <span class="purecounter dateApproved" data-purecounter-start="0"  data-purecounter-end="{{ $ord->view_count }}" data-purecounter-duration="1"></span></span>
									<span id="download_count_{{ $ord->id }}" class="dateApproved ml-4">Downloads: <span class="purecounter dateApproved" data-purecounter-start="0"  data-purecounter-end="{{ $ord->download_count }}" data-purecounter-duration="1"></span></span>
								</div>
							</div>
						</div>
					@endforeach
