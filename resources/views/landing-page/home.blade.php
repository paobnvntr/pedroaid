            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tab1">
                        <p>Our mission is to empower people and communities in San Pedro City, Laguna by giving them easy access to legal representation through a user-friendly platform. In order to improve accessibility for everyone, we work hard to expedite the appointment-scheduling, inquiry-handling, and legal document request processes.</p>
                    </div><!-- End Tab 1 Content -->

                    <div class="tab-pane fade show" id="tab2">
                        <p>PedroAID offers a range of services designed to simplify legal processes for residents of San Pedro City, Laguna:</p>
                        <ol>
                            <li><strong>Appointment Management:</strong> Easily schedule appointments with a legal expert.</li>
                            <li><strong>Inquiry Handling:</strong> Centralized platform for addressing legal inquiries promptly.</li>
                            <li><strong>Legal Document Requests:</strong> Submit requests for various legal documents hassle-free.</li>
                        </ol>
                    </div><!-- End Tab 2 Content -->

                    <div class="tab-pane fade show" id="tab3">
                        <p>Here's why PedroAID stands out as the preferred legal assistance platform in San Pedro City, Laguna:</p>
                        <ul>
                            <li><strong>Tailored for San Pedro City:</strong> Our platform is customized to address the unique legal needs of our community.</li>
                            <li><strong>Efficiency and Convenience:</strong> Experience hassle-free access to legal assistance with just a few clicks.</li>
                            <li><strong>Transparency and Accountability:</strong> We handle inquiries and document requests with professionalism and confidentiality.</li>
                        </ul>
...
<!-- ======= Sangguinang Panlungsod Section ======= -->
...
</div><!-- End Sangguniang Panlungsod Section -->
...
<div class="aid-tracker" id="aid-tracker" data-aos="fade-up">
	<div class="container">
		<div class="row justify-content-center">
			...
			<div class="col-lg-3">
				<div class="text-center text-lg-start">
					<a href="{{ route('tracker')  }}" class="btn-track-now d-flex align-items-center justify-content-center align-self-center">
						<span>Track Now</span>
						<i class="bi bi-arrow-right"></i>
					</a>
				</div>
