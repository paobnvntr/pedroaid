...
<body>
	...
	<df-messenger location="asia-southeast1" project-id="pedroaid" agent-id="20bb3eaf-7d13-44ce-a599-010c62285a82"
		language-code="en" max-query-length="-1">
		<df-messenger-chat-bubble chat-title="PeDroid" chat-subtitle="PedroAID's Bot"
			chat-title-icon="{{ asset('images/PeDroid.svg') }}" chat-width="365"
			chat-icon="{{ asset('images/PeDroid.svg') }}" placeholder-text="Type 'Hi' to start conversation."
