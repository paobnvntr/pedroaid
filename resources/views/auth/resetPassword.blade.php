						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form action="{{ route('resetPassword') }}" method="POST" class="user" id="loginForm">
    									@csrf
										...
										<button type="submit" class="btn btn-primary btn-block btn-user btn-login">Reset Password</button>
									</form>
									<hr>
