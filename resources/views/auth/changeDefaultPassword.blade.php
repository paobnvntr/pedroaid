							...
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h3 class="text-gray-900 font-weight-bold mb-4">Change Default Password</h3>
										<hr>
									</div>

									<form action="{{ route('changeDefaultPassword') }}" method="POST" class="user" id="loginForm">
    									@csrf
                                        <input type="hidden" name="token" value="{{ $token }}">   

                                        <div class="form-group">
                                            <label for="username">Username: <span class="text-gray-900">{{ $username }}</span></label>
										...
										<button type="submit" class="btn btn-primary btn-block btn-user btn-login">Change Password</button>
									</form>
									<hr>
