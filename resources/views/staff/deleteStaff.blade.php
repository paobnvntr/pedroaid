...
@section('contents')
  <div class="d-flex align-items-center justify-content-start addStaff mb-4">
    ...
    <h1 class="mb-0 ml-4">Delete Staff Account</h1>
  </div>

  <div class="p-5">
    <form action="{{ route('staff.destroyStaff', $staff->id) }}" method="POST" class="user">
      @csrf
      @method('DELETE')
      <div class="form-group">
        <p>Are you sure you want to delete <strong>{{ $staff->name }}'s</strong> account permanently?</p>
      </div>
