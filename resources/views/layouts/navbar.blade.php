      ...
      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
        ...
        <div class="notification-container">
          ...
          @foreach ($unreadNotificationsGrouped as $transactionKey => $notifications)
              ...
              <a id="notification_{{ $notifications[0]->id }}" class="dropdown-item d-flex align-items-center notification-item" href="{{ 
              ...
              data-transaction-id="{{ $id }}">
                  ...
                  <div class="font-weight-bold">
                      <div class="text-truncate">New {{ $transactionType }}! @if ($unreadCount > 1) <span class="badge badge-danger">{{ $unreadCount }}</span> @endif</div>
