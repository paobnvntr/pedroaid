        ...
        <div class="d-flex justify-content-center row">
            <div class="card shadow p-5 col-sm-6 mb-sm-0 trackerDetailsForm">
                ...
                <div>
                    ...
                    @endif
                    <form action="{{ route('document-request.saveFeedback', ['id' => $documentRequest->documentRequest_id, 'type' => 'Document Request']) }}" method="POST" class="user feedback-form" id="sendFeedbackForm">
                        @csrf
                        <div class="mb-3">
...
<script>
    ...
    sendFeedbackBtn.addEventListener("click", async () => {
        ...
        try {
            const response = await fetch('{{ route('document-request.validateFeedbackForm', ['id' => $documentRequest->documentRequest_id, 'type' => 'Document Request']) }}', {
                method: 'POST',
                headers: {
