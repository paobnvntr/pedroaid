...
<div class="form-group row">
    <div class="col-sm-6">
        <input name="party1_name" id="party1_name" type="text"
            ...
            placeholder="Current Name and Identity of Party 1: {{ $additional_info->name_identity_1 }}" value="{{ old('party1_name', $additional_info->name_identity_1) }}" disabled>
        @error('party1_name')
    ...
    <div class="col-sm-6">
        <input name="party2_name" id="party2_name" type="text"
            ...
            placeholder="Current Name and Identity of Party 2: {{ $additional_info->name_identity_2 }}" value="{{ old('party2_name', $additional_info->name_identity_2) }}" disabled>
        @error('party2_name')
        <span class="invalid-feedback">{{ $message }}</span>
        @enderror
    </div>
...
<div class="form-group">
    <textarea name="property_details" id="property_details"
        ...
        placeholder="Current Details of the Property/Vehicle: {{ $additional_info->details }}" disabled>{{ old('property_details', $additional_info->details) }}</textarea>
