    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to delete Document Request Feedback ID: <strong>{{ $fdbck->transaction_id }}</strong>?
            </div>
            <div class="modal-footer">
              <form action="{{ route('document-request.destroyFeedback', $fdbck->transaction_id) }}" method="POST" class="user">
                @csrf
                @method('DELETE')
